...
import com.dan.marketapp.databinding.ViewpagerImagesItemBinding

class ViewPager2Images: RecyclerView.Adapter<ViewPager2Images.ViewPager2ImagesViewHolder>() {

    inner class ViewPager2ImagesViewHolder(val binding: ViewpagerImagesItemBinding) : RecyclerView.ViewHolder(binding.root){
